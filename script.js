...
function changeBackground(scene){
  ...
  if(scene === "arrival"){
    body.style.background = "linear-gradient(180deg,#70d8ff,#08657e)";
  }

  if(scene === "villa"){
    body.style.background = "linear-gradient(180deg,#58c7e8,#0b718c)";
  }

  if(scene === "crystal"){
    body.style.background = "linear-gradient(180deg,#1b335f,#061322)";
  }
...
function nextDialogue(){
  ...
  if(dialogueIndex < introDialogue.length){
    ...
    showSpeaker(
      introDialogue[dialogueIndex].speaker,
      introDialogue[dialogueIndex].portrait
    );
